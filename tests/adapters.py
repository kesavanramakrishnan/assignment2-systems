...
from cs336_systems.naive_ddp import DDP, OverlapDDP, ddp_on_after_backward as ddp_on_after_backward_fn
...
def get_flashattention_autograd_function_pytorch() -> type:
    ...
    return TorchFlashAttentionFunction
...
def ddp_on_after_backward(ddp_model: torch.nn.Module, optimizer: torch.optim.Optimizer):
    ...
    """
    ddp_on_after_backward_fn(ddp_model, optimizer)
...
def fsdp_gather_full_params(fsdp_model: torch.nn.Module) -> dict[str, torch.Tensor]:
    ...
    """
    from cs336_systems.fsdp import gather_full_params
